            ...
            while (true)
            {
                ...
                foreach (var particle in this.particles)
                {
                    ...
                    if (freeParticle != null)
                    {
                        ...
                        double forceRow = this.repeller.Gravity * (this.repeller.Position.Row - freeParticle.Position.Row) / range / Math.Sqrt(range);
                        double forceCol = this.repeller.Gravity * (this.repeller.Position.Col - freeParticle.Position.Col) / range / Math.Sqrt(range);
